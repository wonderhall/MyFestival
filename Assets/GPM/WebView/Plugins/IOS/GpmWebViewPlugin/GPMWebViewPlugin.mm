...
#define GPM_WEBVIEW_API_SHOW_URL_DEPRECATED @"gpmwebview://showUrlDeprecated"
#define GPM_WEBVIEW_API_SHOW_HTML_FILE_DEPRECATED @"gpmwebview://showHtmlFileDeprecated"
#define GPM_WEBVIEW_API_SHOW_HTML_STRING_DEPRECATED @"gpmwebview://showHtmlStringDeprecated"
...
- (void)onAsyncMessage: (GPMCommunicatorMessage*)message {
    ...
    if([webviewMessage.scheme isEqualToString:GPM_WEBVIEW_API_SHOW_URL_DEPRECATED]) {
        [self showUrlDeprecated:webviewMessage];
    } else if([webviewMessage.scheme isEqualToString:GPM_WEBVIEW_API_SHOW_HTML_FILE_DEPRECATED]) {
        [self showHtmlFileDeprecated:webviewMessage];
    } else if([webviewMessage.scheme isEqualToString:GPM_WEBVIEW_API_SHOW_HTML_STRING_DEPRECATED]) {
        [self showHtmlStringDeprecated:webviewMessage];
    } else if([webviewMessage.scheme isEqualToString:GPM_WEBVIEW_API_SHOW_URL]) {
...
- (void)showUrlDeprecated:(GPMWebViewMessage*)webViewMessage {
    ...
    [GPMWebView showWithURLDeprecated:url viewController:UnityGetGLViewController() configuration:configuration openCompletion:^(GPMWebViewError *error) {
...
- (void) showHtmlFileDeprecated: (GPMWebViewMessage*)webViewMessage {
    NSDictionary* dataDic = [webViewMessage.data JSONDictionary];
    ...
    [GPMWebView showWithHTMLFileDeprecated:filePath viewController:UnityGetGLViewController() configuration:configuration openCompletion:^(GPMWebViewError *error) {
        GPMWebViewMessage* requestMessage = [[GPMWebViewMessage alloc] init];
        requestMessage.scheme = GPM_WEBVIEW_CALLBACK_CALLBACK;
        requestMessage.callback = webViewMessage.callback;
        requestMessage.error = [error jsonString];
...
- (void) showHtmlStringDeprecated: (GPMWebViewMessage*)webViewMessage {
    NSDictionary* dataDic = [webViewMessage.data JSONDictionary];
    ...
    [GPMWebView showWithHTMLStringDeprecated:htmlString viewController:UnityGetGLViewController() configuration:configuration openCompletion:^(GPMWebViewError *error) {
        GPMWebViewMessage* requestMessage = [[GPMWebViewMessage alloc] init];
        requestMessage.scheme = GPM_WEBVIEW_CALLBACK_CALLBACK;
        requestMessage.callback = webViewMessage.callback;
        requestMessage.error = [error jsonString];
